...
router
    ...
    .put('/books/:id',authenticate,authorize(['admin']),upload.single('image'),bookController.updateItemPut)
    .patch('/books/:id',authenticate,authorize(['admin']),upload.single('image'),bookController.updateItemPatch)
